...
`PhpEcho::addBindableHelper()` otherwise just use `PhpEcho::addHelper()`.<br>
...
that's why the helper definition is created using `PhpEcho::addBindableHelper()`.<br>
...
// instead of use, you can also include once the source code of PhpEcho
use rawsrc\PhpEcho\PhpEcho;
